...
void UIManager::initManager() {
    ...
    /*m_elementSprites[UIElement::CheckboxInactive] = sf::Sprite(charsTexture, sf::IntRect(128 - 4 * 8, 0, 8, 8));
    m_elementSprites[UIElement::CheckboxActive] = sf::Sprite(charsTexture, sf::IntRect(128 - 5 * 8, 0, 8, 8));
    m_elementSprites[UIElement::RadioButtonInactive] = sf::Sprite(charsTexture, sf::IntRect(128 - 6 * 8, 0, 8, 8));
    m_elementSprites[UIElement::RadioButtonActive] = sf::Sprite(charsTexture, sf::IntRect(128 - 7 * 8, 0, 8, 8));
    m_elementSprites[UIElement::Cursor] = sf::Sprite(charsTexture, sf::IntRect(128 - 8 * 8, 0, 8, 8));

    m_elementSprites[UIElement::ArrowUp] = sf::Sprite(charsTexture, sf::IntRect(112, 8, 8, 8));
    m_elementSprites[UIElement::ArrowDown] = sf::Sprite(charsTexture, sf::IntRect(120, 8, 8, 8));
    m_elementSprites[UIElement::ArrowLeft] = sf::Sprite(charsTexture, sf::IntRect(8, 8, 8, 8));
    m_elementSprites[UIElement::ArrowRight] = sf::Sprite(charsTexture, sf::IntRect(0, 8, 8, 8));*/
...
void UIManager::scaleSymbols(const sf::Vector2f &scale) {
    /*m_elementSprites[UIElement::CheckboxInactive].setScale(scale);
    m_elementSprites[UIElement::CheckboxActive].setScale(scale);
    m_elementSprites[UIElement::RadioButtonInactive].setScale(scale);
    m_elementSprites[UIElement::RadioButtonActive].setScale(scale);
    m_elementSprites[UIElement::Cursor].setScale(scale);

    m_elementSprites[UIElement::ArrowUp].setScale(scale);
    m_elementSprites[UIElement::ArrowDown].setScale(scale);
    m_elementSprites[UIElement::ArrowLeft].setScale(scale);
    m_elementSprites[UIElement::ArrowRight].setScale(scale);*/
